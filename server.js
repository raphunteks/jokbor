 ...
 * Memuat SELURUH teks visual halaman dan METADATA SEO secara terpusat!
 */
const DEFAULT_SITE_CONTENT = {
  ...
  // === METADATA SEO REGISTRY (BISA DI-CRUD DARI ADMIN) ===
  seo: {
 ...
 * MENGGUNAKAN DATA REDIS UNTUK SEO AGAR SEJALAN DENGAN CMS
 */
function buildSeoPayload(req, contentData, sectionKey = 'home') {
  ...
  const reviewSchemaItems = reviewItems.slice(0, 5).map(rev => ({ // Ambil 5 Review Teratas saja untuk skema
    "@type": "Review",
